...
abstract class CreateNewAdminAccountController extends GetxController {
  createNewAccount();
}

class CreateNewAdminAccountControllerImp
    extends CreateNewAdminAccountController {
  ...
  createNewAccount() async {
    ...
    if (fomrstate!.validate()) {
      ...
      update();
      var response = await adminData.createNewAdminAccount(
